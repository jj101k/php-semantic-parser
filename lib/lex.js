        ...
        if(!this._possible) {
            this._possible = {
                ...
                none: [
                    ...
                    [new RegExpTokenMatch(/^[.]\d+/, 2), "number"],
                    [new RegExpTokenMatch(/^0b[01]+/, 3), "number"],
                    [new RegExpTokenMatch(/^0x[0-9a-f]+/, 3), "number"],
                    ...
                    [new StringTokenMatch("??"), "doubleQuestionMark"],
            ...
            for(const tokens of Object.values(this._possible)) {
                tokens.sort(
                    (a, b) => (+!!a[0] - +!!b[0]) || b[0].minLength - a[0].minLength
                )
            }
        }
