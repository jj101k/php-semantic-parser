...
class ParserClassSymbol extends ParserBase {
    ...
    get modes() {
        ...
        const initialValue = ParserStaticExpression.expressionParser(php => this.valueValues.push(php), "postValue")
        ...
        return {constName, initial, initialValue, nextVariable, postValue, postVariable}
    }
}
