...
export class ParserLine extends ParserBase {
    ...
    get modes() {
        ...
        return {
            ...
            lineEndOrMoreStatic: new ParserStateHandler({
                comma: () => ParserStateChange.mode("staticVar"),
                semicolon: () => this.end,
                $pop: consumer(ParserNonPhp),
            }),
            nonPhpElse: new ParserStateHandler({
                bareword_else: () => ParserStateChange.mode("else"),
                bareword_endif: () => this.end,
                ...ParserLine.lineParser(node => this.nodes.push(node)),
            }),
            possibleLabel: new ParserStateHandler({
                colon: () => {
            ...
            postTry: new ParserStateHandler({
                ...ParserBase.commentOrSpace(node => this.nodes.push(node)),
            ...
            staticSymbolOrRef: new ParserStateHandler({
                varname: () => {
                    const e = new ParserExpression()
            ...
            staticVar: new ParserStateHandler({
                varname: () => {
                    const e = new ParserExpression()
                    e.isStaticDeclaration = true
                    this.nodes.push(e)
