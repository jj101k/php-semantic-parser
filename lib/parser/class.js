...
class ParserAnyClass extends ParserBase {
    ...
    get modes() {
        ...
        return {inExtends, inImplements, implementsNext, info, initial, postExtends, preCurly}
    }
}
...
export class ParserClass extends ParserAnyClass {
    ...
    get modes() {
        ...
        return {...super.modes, initial, name}
    }
}
...
export class ParserAnonymousClass extends ParserAnyClass {
    ...
    get modes() {
        ...
        return {...super.modes, implementsNext, info, initial, postExtends}
    }
}
