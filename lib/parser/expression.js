...
export class ParserStaticExpression extends ParserBase {
    ...
    get modes() {
        ...
        return {
            ...
            maybeArray: new ParserStateHandler({
                openBracket: () => {
            ...
            postBracket: new ParserStateHandler({
...
export class ParserExpression extends ParserStaticExpression {
    ...
    get modes() {
        ...
        return {
            ...static_modes,
            castOrGroup: new ParserStateHandler({
            ...
            maybeOldArray: new ParserStateHandler({
                closeBracket: () => {
                    this.castTo = "array"
