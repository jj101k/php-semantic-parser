...
export class ParserExpression extends ParserStaticExpression {
    ...
    static expressionParser(f, next_mode, allow_empty = false) {
        ...
        if(allow_empty) {
            parser.closeBracket = () => ({mode: next_mode, reconsume: true})
            parser.closeCurly = () => ({mode: next_mode, reconsume: true})
            parser.semicolon = () => ({mode: next_mode, reconsume: true})
        }
        return parser
    }
    /**
    ...
    get modes() {
        ...
        return {
            ...
            initial: {
                ...
                bareword_static: () => ({mode: "staticSymbol"}),
                minusminus: () => {
