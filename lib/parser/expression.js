...
export class ParserExpression extends ParserBase {
    ...
    static expressionParser(f, next_mode) {
        ...
        return Object.assign(
            ...
            this.staticExpressionParser(f, next_mode, true)
        )
    }
    /**
     *
     ...
     * @param {(p: ParserBase) => *} f
     * @param {string} next_mode
     * @param {boolean} as_dynamic
     */
    static staticExpressionParser(f, next_mode, as_dynamic = false) {
        const handle_static_expression = this.handleExpression(f, next_mode)
        return {
            bareword_array: handle_static_expression,
            bareword_false: handle_static_expression,
            bareword_function: handle_static_expression,
            bareword_true: handle_static_expression,
            not: handle_static_expression,
            number: handle_static_expression,
            openBracket: handle_static_expression,
            openSquare: handle_static_expression,
            quoteDouble: handle_static_expression,
            quoteSingle: handle_static_expression,
            space: () => {},
        }
    }
    constructor() {
