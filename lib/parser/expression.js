...
import { ParserBooleanOperator as ParserBooleanOperator, ParserBitOperator } from "./boolean-operator"
    ...
    get modes() {
        const static_modes = {
            ...
            postArgument: {
                ...
                bitOperator: c => {
                    const assignment = new ParserBitOperator(c, this.nodes.pop(), this.isStatic)
                    this.nodes.push(assignment)
                    return { consumer: assignment }
                },
                booleanOperator: c => {
