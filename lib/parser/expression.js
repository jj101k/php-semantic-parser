...
export class ParserStaticExpression extends ParserBase {
    ...
    get modes() {
        ...
        return {initial, maybeArray, postArgument, postBracket}
    }
}
...
export class ParserExpression extends ParserStaticExpression {
    ...
    get modes() {
        ...
        return {...static_modes, castOrGroup, initial, maybeOldArray, postArgument, postCast, staticSymbolOrRef}
    }
}
