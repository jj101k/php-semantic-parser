 ...
 * @typedef {{match: singleMatch | singleMatch[], abortMatch?: string, endMatch?: string, finalEndMatch?: string, then: lexConfig | string}} lexConfigDetail
 */
